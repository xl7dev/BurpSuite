 ...
 *
 * Extensions can call <code>IBurpExtenderCallbacks.getHelpers</code> to obtain an instance of this interface.
 */
public interface IExtensionHelpers {
   ...
   *
   * @param request An <code>IHttpRequestResponse</code> object containing the request to be analyzed.
   * @return An <code>IRequestInfo</code> object that can be queried to obtain details about the request.
   */
   ...
   * This method can be used to analyze an HTTP request, and obtain various key details about it.
   *
   * @param httpService The HTTP service associated with the request. This is optional and may be <code>null</code>, in which case the resulting <code>IRequestInfo</code> object will not include the
   *                    full request URL.
  ...
  /**
   * This method can be used to analyze an HTTP request, and obtain various key details about it. The resulting <code>IRequestInfo</code> object will not include the full request URL. To obtain the
   * full URL, use one of the other overloaded <code>analyzeRequest()</code> methods.
   *
   * @param request The request to be analyzed.
   * @return An <code>IRequestInfo</code> object that can be queried to obtain details about the request.
   */
   ...
   * @return An <code>IResponseInfo</code> object that can be queried to obtain details about the response.
   */
  IResponseInfo analyzeResponse(byte[] response);

  /**
   * This method can be used to retrieve details of a specified parameter within an HTTP request. <b>Note:</b> Use <code>analyzeRequest()</code> to obtain details of all parameters within the
   * request.
   *
   * @param request       The request to be inspected for the specified parameter.
   * @param parameterName The name of the parameter to retrieve.
   * @return An <code>IParameter</code> object that can be queried to obtain details about the parameter, or <code>null</code> if the parameter was not found.
   */
  ...
  /**
   * This method can be used to convert data from String form into an array of bytes. The conversion does not reflect any particular character set, and a character with the hex representation 0xWXYZ
   * will always be converted into a byte with the representation 0xYZ. It performs the opposite conversion to the method <code>bytesToString()</code>, and byte-based data that is converted to a
   * String and back again using these two methods is guaranteed to retain its integrity (which may not be the case with conversions that reflect a given character set).
   *
   ...
   * @param from          The offset within <code>data</code> where the search should begin.
   * @param to            The offset within <code>data</code> where the search should end.
   ...
   * @param body    The body of the message, of <code>null</code> if the message has an empty body.
   ...
   * @param parameter An <code>IParameter</code> object containing details of the parameter to be added. Supported parameter types are: <code>PARAM_URL</code>, <code>PARAM_BODY</code> and
   ...
   * @param parameter An <code>IParameter</code> object containing details of the parameter to be removed. Supported parameter types are: <code>PARAM_URL</code>, <code>PARAM_BODY</code> and
   *                  <code>PARAM_COOKIE</code>.
  ...
  /**
   * This method updates the value of a parameter within an HTTP request, and if appropriate updates the Content-Length header. <b>Note:</b> This method can only be used to update the value of an
   * existing parameter of a specified type. If you need to change the type of an existing parameter, you should first call <code>removeParameter()</code> to remove the parameter with the old type,
   * and then call <code>addParameter()</code> to add a parameter with the new type.
   *
   * @param request   The request containing the parameter to be updated.
   * @param parameter An <code>IParameter</code> object containing details of the parameter to be updated. Supported parameter types are: <code>PARAM_URL</code>, <code>PARAM_BODY</code> and
   *                  <code>PARAM_COOKIE</code>.
  ...
  /**
   * This method can be used to toggle a request's method between GET and POST. Parameters are relocated between the URL query string and message body as required, and the Content-Length header is
   * created or removed as applicable.
   *
   ...
   * @return An <code>IHttpService</code> object based on the details provided.
   */
  ...
  /**
   * This method constructs an <code>IParameter</code> object based on the details provided.
   *
   * @param name  The parameter name.
   * @param value The parameter value.
   * @param type  The parameter type, as defined in the <code>IParameter</code> interface.
  ...
  /**
   * This method constructs an <code>IScannerInsertionPoint</code> object based on the details provided. It can be used to quickly create a simple insertion point based on a fixed payload location
   * within a base request.
   *
   ...
   * @return An <code>IScannerInsertionPoint</code> object based on the details provided.
   */
