...
/**
 * This interface is used to retrieve key details about an HTTP request. Extensions can obtain an <code>IRequestInfo</code> object for a given request by calling
...
public interface IRequestInfo {
   ...
   *
   * @return An indication of the content type of the message body. Available types are defined within this interface.
   */
  byte getContentType();
}
