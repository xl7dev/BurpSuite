 ...
 *
 * <b>Note:</b> The setter methods generally can only be used before the message has been processed, and not in read-only contexts. The getter methods relating to response details can only be used
 * after the request has been issued.
 */
public interface IHttpRequestResponse {
   ...
   *
   * @return An <code>IHttpService</code> object containing details of the HTTP service.
   */
   ...
   *
   * @param httpService An <code>IHttpService</code> object containing details of the new HTTP service.
   */
