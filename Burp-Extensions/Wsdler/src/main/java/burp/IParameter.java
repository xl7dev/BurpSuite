...
public interface IParameter {
   ...
   *
   * @return The start offset of the parameter name within the HTTP request, or -1 if the parameter is not associated with a specific request.
   */
  int getNameStart();
   ...
   *
   * @return The end offset of the parameter name within the HTTP request, or -1 if the parameter is not associated with a specific request.
   */
  int getNameEnd();
   ...
   *
   * @return The start offset of the parameter value within the HTTP request, or -1 if the parameter is not associated with a specific request.
   */
  int getValueStart();
   ...
   *
   * @return The end offset of the parameter value within the HTTP request, or -1 if the parameter is not associated with a specific request.
   */
  int getValueEnd();
}
