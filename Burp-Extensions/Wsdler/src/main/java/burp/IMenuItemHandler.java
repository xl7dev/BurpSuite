 ...
 *
 * @deprecated Use <code>IContextMenuFactory</code> instead.
 */
@Deprecated
public interface IMenuItemHandler {
   ...
   *
   * @param menuItemCaption The caption of the menu item which was clicked. This parameter enables extensions to provide a single implementation which handles multiple different menu items.
   * @param messageInfo     Details of the HTTP message(s) for which the context menu was displayed.
   */
