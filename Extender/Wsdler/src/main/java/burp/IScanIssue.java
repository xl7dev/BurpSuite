...
/**
 * This interface is used to retrieve details of Scanner issues. Extensions can obtain details of issues by registering an <code>IScannerListener</code> or by calling
 * <code>IBurpExtenderCallbacks.getScanIssues()</code>. Extensions can also add custom Scanner issues by registering an <code>IScannerCheck</code> or calling
 * <code>IBurpExtenderCallbacks.addScanIssue()</code>, and providing their own implementations of this interface
 */
public interface IScanIssue {
   ...
   *
   * @return The issue severity level. Expected values are "High", "Medium", "Low", "Information" or "False positive".
   */
  String getSeverity();
   ...
   *
   * @return A background description for this type of issue, or <code>null</code> if none applies.
   */
   ...
   *
   * @return A background description of the remediation for this type of issue, or <code>null</code> if none applies.
   */
   ...
   *
   * @return Detailed information about this specific instance of the issue, or <code>null</code> if none applies.
   */
   ...
   *
   * @return Detailed information about the remediation for this specific instance of the issue, or <code>null</code> if none applies.
   */
