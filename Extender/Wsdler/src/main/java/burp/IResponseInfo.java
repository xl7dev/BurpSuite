...
/**
 * This interface is used to retrieve key details about an HTTP response. Extensions can obtain an <code>IResponseInfo</code> object for a given response by calling
...
public interface IResponseInfo {
   ...
   *
   * @return A list of <code>ICookie</code> objects representing the cookies set in the response, if any.
   */
